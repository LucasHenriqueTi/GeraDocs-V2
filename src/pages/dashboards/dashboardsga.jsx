    ...
    >
      ...
      <Box
        sx={{
          ...
          height: "70%",
          zIndex: 999999, // Ajusta z-index para que não sobreponha o conteúdo principal
        }}
      >
        <SideMenu />
      </Box>
      ...
      <Box
        sx={{
          ...
          alignItems: "flex-end",
          height: "100%",
          zIndex: 999, // Garantir que a imagem não sobreponha outros componentes
        }}
      >
        <img
      ...
      >
        ...
        <StyledButton
          onClick={() => navigate("/contrato-venda")}
          sx={{
            display: "flex",
            justifyContent: "center",
            alignItems: "center",
